...
import 'package:stronzotpfmobile/app/providers/providers.dart';
import 'package:stronzotpfmobile/app/views/main.view.dart';
import 'package:stronzotpfmobile/shared/helpers/snack_bar_helper.dart';

class LoginPage extends ConsumerWidget {
  LoginPage({Key? key}) : super(key: key);

  final _loginFieldController = TextEditingController.fromValue(
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    _gotoMainPage() => Navigator.pushReplacement(
          ...
          child: ListView(
            ...
            children: [
              ...
              _buildButtonContainer(
                  _handleLogin, authState.isLoading || userState.isLoading),
            ],
          ),
        ),
      ),
